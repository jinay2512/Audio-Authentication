<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Navy_reg.aspx.cs" Inherits="BE_Project.Web.Navy_reg" %>
        ...
        <table style="width:750px;">
            ...
            <table style="width:100%;">
                    ...
                    <tr><td class="style2">Password</td><td class="style1" align="center">
                        <asp:TextBox ID="TextBox6" runat="server" TextMode="Password"></asp:TextBox></td><td> &nbsp;</td></tr>
                    ...
                    <tr>
                        ...
                        <td class="style1"  align="center">
                            ...
                            <p id="displayArea"></p>
                          <div visible="false">  <p>You pointed on x = 
                                ...
                                <asp:TextBox ID="y5" runat="server" TextMode="Password"></asp:TextBox></p></div>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
