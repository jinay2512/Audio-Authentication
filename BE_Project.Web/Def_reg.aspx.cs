...
{
    public partial class Def_reg : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into reg values('" + TextBox1.Text + "','" + encrypt + "','" + x1.Text + "','" + y1.Text + "','" + x2.Text + "','" + y2.Text + "','" + x3.Text + "','" + y3.Text + "','" + x4.Text + "','" + y4.Text + "','" + x5.Text + "','" + y5.Text + "','" + g4 + "','" + encrypttime + "','" + RadioButtonList1.SelectedItem.Value + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','Defence','0')", con);
            cmd.ExecuteNonQuery();
            con.Close();
