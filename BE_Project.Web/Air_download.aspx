<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Air_download.aspx.cs" Inherits="BE_Project.Web.Air_download" %>
             ...
             <tr>
                <td style="background-color: #996633"  colspan="7">
                    <asp:Menu ID="Menu1" runat="server" Font-Bold="True" Font-Italic="True" 
                        ...
                        <Items>
                            <asp:MenuItem Text="Upload_Files" Value="Home" NavigateUrl="~/Air_upload.aspx"></asp:MenuItem>
                            <asp:MenuItem Text="Download_Files" Value="Sign In" 
                                NavigateUrl="~/Air_download.aspx"></asp:MenuItem>
