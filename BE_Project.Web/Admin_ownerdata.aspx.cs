...
{
    public partial class Admin_ownerdata : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("insert into uploadfile values('" + Label1.Text + "','" + TextBox1.Text + "',@files,'Admin')", con);
