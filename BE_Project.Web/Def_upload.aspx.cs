...
{
    public partial class Defence_upload : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into uploadfile values('" + Label1.Text + "','" + TextBox1.Text + "',@files,'Defence','" + fext + "')", con);
